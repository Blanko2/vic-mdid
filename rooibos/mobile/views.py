...
def m_main(request):
    ...
    return render_to_response('mobileHome.html', {'defaultDatabase':'gallica'}, context_instance=RequestContext(request))
...
def m_showImage(request):
	...
	return render_to_response('imageViewer.html', {'imageData':"gus"})
