...
def merge_dictionaries(dict1, dict2):
    ...
    for key in dict1:
      ...
      if newKey in parameters.parammap:	# all types of parameter defined for this class
...
def build_parameters(query, params):
  # build parameters dictionary to search by
    ...
    params, unsupported_parameters = merge_dictionaries(para_map, params)
...
def search(term, params, off, num_results_wanted) :
     ...
     print params
     print empty_params
     params = merge_dictionaries(empty_params, params)[0]
     print "NGA params:"
     print params
