...
BASE_URL = "http://barretts.ecs.vuw.ac.nz:8585/providence/app/lib/ca/Search/MdidSearcher2.php?"
...
def parse_data(raw_data):
    ...
    #print "in local.py 89;   count, num_results = " + str(count) + ", " + str(num_results)
...
def getImage(identifier):
    ...
    #print "in local getImage, meta is "+str(meta)+"\n\n\n\n"+str(meta.__class__)
    try:
        print "in local getImage, metastring is "+str(meta)
    ...
    #print "in local getImage, loaded meta into JSON"
    ...
    print "local getImage made image"
    return img
